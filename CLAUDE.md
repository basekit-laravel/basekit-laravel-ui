...
This repository contains a Laravel package (`basekit-laravel-ui`) that provides
`A modular Laravel UI component library with reusable Blade components, Tailwind 4 theming, and a built-in style guide.`. The canonical project instructions live in `AGENTS.md` and always take
