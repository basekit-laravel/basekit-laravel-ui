<div class="space-y-10" x-data="{
    ...
    <!-- Alerts -->
    <x-basekit-ui::styleguide.section-toggle section="alerts" title="Alerts" description="Inline status messages">
        <div class="space-y-6">
            <!-- Variants -->
            <div class="space-y-2">
...
<x-basekit-ui::alert variant="danger" title="Confirm Action"
    ...
    <!-- Empty States -->
    <x-basekit-ui::styleguide.section-toggle section="empty" title="Empty State" description="Empty content placeholder">
        <div class="space-y-6">
            <!-- Variants -->
            <div class="space-y-2">
                <h4 class="text-sm text-slate-500 font-medium">Variants</h4>
...
<x-basekit-ui::empty-state size="lg" title="Large empty state"
    ...
    <!-- Spinners -->
    <x-basekit-ui::styleguide.section-toggle section="spinners" title="Spinners" description="Loading indicator">
        <div class="space-y-6">
            <!-- Sizes -->
            <div class="space-y-2">
                <h4 class="text-sm text-slate-500 font-medium">Sizes</h4>
...
<x-basekit-ui::spinner size="sm"
    ...
    <!-- Progress Bars -->
    <x-basekit-ui::styleguide.section-toggle section="progress" title="Progress Bars" description="Progress bar indicator">
        <div class="space-y-6">
            <!-- Variants -->
            <div class="space-y-2">
                <h4 class="text-sm text-slate-500 font-medium">Variants</h4>
...
<x-basekit-ui::progress value="40" size="lg" variant="primary"
    ...
    <!-- Skeletons -->
    <x-basekit-ui::styleguide.section-toggle section="skeletons" title="Skeletons" description="Content loading placeholder">
        <div class="space-y-6">
            <!-- Variants -->
            <div class="space-y-2">
                <h4 class="text-sm text-slate-500 font-medium">Variants</h4>
...
<x-basekit-ui::skeleton variant="text" size="lg"
    ...
    <!-- Tooltips -->
    <x-basekit-ui::styleguide.section-toggle section="tooltips" title="Tooltips" description="Hover/focus hint content">
        <div class="space-y-6">
            <!-- Positions -->
            <div class="space-y-2">
...
<x-basekit-ui::tooltip position="right">
    ...
    <!-- Toasts -->
    <x-basekit-ui::styleguide.section-toggle section="toasts" title="Toasts" description="Transient notifications">
        <div class="space-y-6">
            <!-- Variants -->
            <div class="space-y-2">
                <h4 class="text-sm text-slate-500 font-medium">Variants</h4>
