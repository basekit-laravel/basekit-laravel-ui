...
<nav {{ $attributes->twMerge('bk-pagination' . ($responsive ? ' bk-pagination--responsive' : '')) }} role="navigation" aria-label="Pagination">
    @if ($responsive)
                ...
                <div class="bk-pagination__meta">
                    ...
                    @if ($hasPerPageSelector())
                        ...
                        <form method="GET" action="{{ $perPageAction }}" class="bk-pagination__per-page">
                            ...
                            <label class="bk-pagination__per-page-label"
                                for="bk-pagination-per-page-desktop-{{ $perPageName }}">
                                {{ $perPageLabel }}
                            </label>

                            <select id="bk-pagination-per-page-desktop-{{ $perPageName }}"
                                name="{{ $perPageName }}" class="bk-pagination__per-page-select"
        ...
        <div class="bk-pagination__mobile">
            @if (!$onFirstPage())
                <a href="{{ $pageUrl($currentPage - 1) }}" class="bk-pagination__link" rel="prev">
                    <x-heroicon-o-chevron-left class="w-5 h-5" />
                    <span>{{ $previousLabel }}</span>
            ...
            <span class="bk-pagination__mobile-indicator">
            ...
            <div class="bk-pagination__meta">
                ...
                @if ($hasPerPageSelector())
                    ...
                    <form method="GET" action="{{ $perPageAction }}" class="bk-pagination__per-page">
                        ...
                        <label class="bk-pagination__per-page-label"
                            for="bk-pagination-per-page-{{ $perPageName }}">
                            {{ $perPageLabel }}
                        </label>
