...
namespace BasekitLaravel\BasekitLaravelUi\Support;

/**
 * Maps a theme color name to its full 50-950 shade palette.
 *
 * The palettes ship with the package so consumers can render branding colours
 * without depending on a third-party colour system (e.g. Filament). Each value
 * is a valid CSS colour, so entries can be emitted directly as CSS custom
 * properties or mapped to Tailwind utility classes.
 */
final class ThemeColor
{
    ...
    /**
     * Whether a palette is registered.
     */
    public static function has(string $name): bool
    {
        return isset(self::COLORS[strtolower($name)]);
    }

    /**
     * Resolve a palette by name, defaulting to indigo for unknown names.
     *
     * @return array<int, string>
     */
    public static function palette(string $name): array
    {
        return self::COLORS[strtolower($name)] ?? self::COLORS['indigo'];
    }
}
